	...
	public ModelMapper modelMapper() {
		...
		modelMapper.typeMap(Task.class, TaskDTO.class).addMappings(mapper -> {
			...
			mapper.map(src -> src.getAssignedTo() != null ? src.getAssignedTo().getUserId() : null,
					TaskDTO::setAssignedToId);
			mapper.map(src -> src.getAssignedTo() != null ? src.getAssignedTo().getFullName() : null,
					TaskDTO::setAssignedToName);

			mapper.map(src -> src.getDepartment() != null ? src.getDepartment().getDepartmentId() : null,
					TaskDTO::setDepartmentId);
			mapper.map(src -> src.getDepartment() != null ? src.getDepartment().getName() : null,
					TaskDTO::setDepartmentName);
